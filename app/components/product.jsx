...
export default function Product({ id, title, price, imgUrl,isDarkMode}) {
  ...
  return (
    ...
    <div
      ...
      key={id}
      className={`font-bold bg-white text-black p-5 rounded-lg relative w-52 h-60 shadow-[12px_13px_6px_0_rgba(36,37,38,0.25)] 
      ${hovered?"border-solid border-ACMLIGHT  border-2":""} `}
    >
      <Image alt="" src={imgUrl} width={180} height={200} className="h-36" />
      <div
