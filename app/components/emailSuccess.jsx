...
export default function EmailSuccess({ handleModalClose, handleEnter, handleLeave }) {
    return (
        <div className=" w-full h-full flex flex-col items-center ">
            ...
            <p className=" animate-slideIn w-4/5 h-32 text  text-lg">You have received an email confirming and reserving your products for your recent order. Please visit the ACM office to make the payment and pick up your products.</p>
            <Link href={'/'}
