...
export default function HeroScreen( {scrollToProductList, isDarkMode}) {
  return (
    <div style={{ background: isDarkMode?"linear-gradient(180deg, #D90000 88.89%, #242526 100%)":"#34A3D9" }} className="flex flex-col items-center justify-center min-h-screen bg-cover bg-center w-full">
