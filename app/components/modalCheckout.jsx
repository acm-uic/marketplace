            ...
            {showModal &&
                <Overlay handleModalClose={handleModalClose}>
                    <div onClick={(e) => e.stopPropagation()}
                        ...
                        {loading ? (<Loading />) : (
                            <>
                                {error ? (<EmailError handleModalClose={handleModalClose} handleEnter={handleEnter} handleLeave={handleLeave} setError={setError} />) : (
                                    <>
                                        {emailSent ? (
                                            <EmailSuccess handleModalClose={handleModalClose} handleEnter={handleEnter} handleLeave={handleLeave} />
                                        ) : (<>
                                            ...
                                            <div className="flex flex-row h-3/4 w-full mb-4">
                                                <form className="flex flex-col font-medium items-center justify-center w-1/2">
                                                    <div className="w-3/4 mb-4 ">
                                                        ...
                                                        <input ref={nameRef} className="w-full h-9 border-[1.5px] rounded-3xl pl-4 border-black border-solid " placeholder="Name: " />
                                                    </div>
                                                    <div className="w-3/4">
                                                        <div className="flex flex-row justify-between">
                                                        ...
                                                        <input ref={emailRef} className="w-full h-9 rounded-3xl  pl-4 border-[1.5px] border-black border-solid" placeholder="Email: " />
                                                    </div>
                                                </form>
